...
Tema coding:
Codingan ini mengusung tema kos-kosan dimana di codingan ini akan terdapat 2 package yaitu package pemilik dengan class admin(class main codingan ini), lalu ada Package kedua yaitu package penyewa dengan class penghuni.
